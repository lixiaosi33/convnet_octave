...
sampleTestImages = testImages(:,:,1:50);
sampleTestLabels = testLabels(1:50);

opttheta = minFuncSGD(@(x,y,z) cnnCost(x,y,z,numClasses,filterDim,...
                      numFilters,poolDim),theta,images,labels,options, sampleTestImages, sampleTestLabels, numClasses, filterDim, numFilters, poolDim);
